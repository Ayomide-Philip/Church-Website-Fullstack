...
import { foundingandEstablishing } from "../home";
          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
                {foundingandEstablishing.title}
              </h1>
              <p className="mt-6 text-xl/8 text-gray-700">
                {FoundingandEstablishing.p1}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <ul className="mt-8 space-y-5 text-gray-600">
                {foundingandEstablishing.placeIdentified.map((place, idx) => {
                  return (
                    <li className="flex gap-x-1" key={idx}>
                      <ArrowLongRightIcon
                        aria-hidden="true"
              ...
              <p className="mt-3 text-xl/8 text-gray-700">
                {foundingandEstablishing.p2}
              </p>
              <p className="mt-3 text-xl/8 text-gray-700">
                {foundingandEstablishing.p3}
              </p>
              <p className="mt-3 text-xl/8 text-gray-700">
                {foundingandEstablishing.p4}
              </p>
            </div>
          </div>
        </div>
